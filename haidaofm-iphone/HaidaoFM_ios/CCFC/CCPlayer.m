                                                 ...
                                                 from:(UIViewController *)controller
{
    ...
    [controller presentModalViewController:playlistView animated:animated];
                                             ...
                                             animated:(BOOL)animated
{
	...
	[delegate presentModalViewController:playlistView animated:animated];	[playlistView release];
	return playlistView;
}
